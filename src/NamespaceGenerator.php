...
class NamespaceGenerator
{
    ...
    {
        $this->illuminatePath = $composer->getConfig()->get('vendor-dir') . '/illuminate';
    ...
    private function addNameSpace()
    {
        ...
        $traverser->addVisitor(new class($this->getFunName(), $this->nameSpace) extends NodeVisitorAbstract {
            private $methods;
            private $nameSpace;
    ...
    private function readPhpFiles($directory): array
    {
        $contents = [];
